...
<div id="id01" class="modal modal">
 ...
 <div class="container login">
  <br><br><br><br><br>
    <div class="row">
      <div class="col-md-5 login-logo">
          <img src="\imagens\SYSREL.png" >     </div>
        <div class="col-md-7 login-form">

            <div class="clearfix">
               
                <form id="loginform" method="post" action="/pt/login/" onsubmit="postAJAX(this.id,'Processando…');return false;">
                  <div class="form-group">
                     <input id="Usuario" type="text" autofocus  placeholder="Digite seu Login ou Prontuário" name="uname" required>
                    <div class="help-block alert alert-danger" style="display:none;"></div>
                  </div>
                    ...
                    <button type="submit" class="btn btn-primary "><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> Entrar</button>
                    <a href="telaRecuperacaoSenha.php" target="_blank">Esqueceu sua Senha ?</a>
