		  ...
		  <?php 
				...
				if (isset($_GET["subcat2"])){
			    	...
			    	$result = $conexao->query($sql);
					    ...
					    echo '</select> <br><br><input type="button" onclick="verificaLinhaSelecionada();" class="btn btn-sucess" value="Selecionar" name="btnCat" data-toggle="modal" data-target="#modalVincular">';
		  ...
		  <script>
		  	function verificaLinhaSelecionada() { 
				...
				if (itemSelecionado != 0){
			        $(".modal-body #idLinha").val(itemSelecionado);
				}
			...
			function pegaCategoria() { 
				...
				if (!itemSelecionado == 0){
					...
					document.location=('pesquisaLinhaSelect.php?cat=' + itemSelecionado); 
				}
		 	...
		 	function pegasubCategoria(cat) { 
				...
				if (!itemSelecionado == 0){
			    	...
			    	document.location=('pesquisaLinhaSelect.php?cat=' + cat + "&subcat=" + String(itemSelecionado)); 
		   		}
		 	}
		 	function pegasubCategoria2(cat, subcat) { 
				...
				if (!itemSelecionado == 0){
			    	...
			    	document.location=('pesquisaLinhaSelect.php?cat=' + cat + "&subcat=" +String(x)+ "&subcat2="+String(itemSelecionado));
				}
