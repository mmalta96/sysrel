...
<body>
	...
	<div class="container">
		...
		<?php 
            ...
            $ano = $_GET["ano"];
		?>
		<h3>Relatório de Docentes do Grupo no ano de <?php echo $ano; ?></h3>
        ...
        <table class="table table-striped">
            <thead>
            	...
            	<?php 
            		...
            		$sql = "SELECT D.NOME, D.DESC_TITULACAO FROM TB_DOCENTES D INNER JOIN TB_DOCENTE_GRUPO DG ON DG.ID_DOCENTE_FK = D.ID AND DG.DATA_INICIO BETWEEN '".$ano."-01-01 00:00:00' AND '".$ano."-12-31 23:59:59' AND DG.ID_GRUPO_FK = ".$_SESSION["idGrupoAtual"];
            		...
            		while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<h5>Titulação:".$row["DESC_TITULACAO"]."</h5>";
