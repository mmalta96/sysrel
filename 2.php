...
<body>
	...
	<div class="container">
		...
		<?php 
            ...
            $ano = $_GET["ano"];
		?>
		<h3>Relatório de Linhas de Pesquisa do Grupo e Seus Respectivos Docentes no ano de <?php echo $ano; ?></h3>

        <table class="table table-striped">
            <thead>
                <tr>
                    <th><h3>Linhas de Pesquisa </h3></th>
                </tr>
            </thead>
            	...
            	<?php 
            		 ...
            		 $sql = "SELECT LP.ID, LP.NOME FROM TB_LINHA_PESQUISA LP INNER JOIN TB_LINHA_GRUPO LG ON LP.ID = LG.ID_LINHA AND LG.DATA_INICIO BETWEEN '".$ano."-01-01 00:00:00' AND '".$ano."-12-31 23:59:59' OR LG.DATA_TERMINO BETWEEN '".$ano."-01-01 00:00:00' AND '".$ano."-12-31 23:59:59' AND LG.ID_GRUPO = ".$_SESSION["idGrupoAtual"];
            		...
            		while ($row = $result->fetch_assoc()) {
                        ...
                        $sql2 = "SELECT D.NOME as DOCENTE
                            FROM tb_docentes D 
                            INNER JOIN tb_docente_linha DL
                            on D.ID = DL.ID_DOCENTE_FK
                            AND DL.ID_GRUPO_FK = 8
                            AND DL.ID_LINHA_PESQUISA_FK = '".$row["ID"]."'
