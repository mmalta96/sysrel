...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 27-Nov-2018 às 23:08
...
(5, 'ADMIN', 'admin@admin.com.br', '55de1e4b50da90d84249ab53f61a99a6959d4c6fd8a6c402670b4115c137beae', '55de1e4b50da90d84249ab53f61a99a6959d4c6fd8a6c402670b4115c137beae', 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_convidado_reuniao`
--

DROP TABLE IF EXISTS `tb_convidado_reuniao`;
CREATE TABLE IF NOT EXISTS `tb_convidado_reuniao` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `NOME` varchar(50) NOT NULL,
  `ID_REUNIAO_FK` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `ID_REUNIAO_FK` (`ID_REUNIAO_FK`)
) ENGINE=MyISAM AUTO_INCREMENT=34 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_convidado_reuniao`
--

INSERT INTO `tb_convidado_reuniao` (`ID`, `NOME`, `ID_REUNIAO_FK`) VALUES
(2, 'Convidado 1', 79),
(3, 'Convidado 2', 79),
(4, 't1', 78),
(5, 't2', 78),
...
--
-- Estrutura da tabela `tb_detalhe_reuniao`
--

DROP TABLE IF EXISTS `tb_detalhe_reuniao`;
CREATE TABLE IF NOT EXISTS `tb_detalhe_reuniao` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_REUNIAO_FK` int(11) NOT NULL,
  `HORA_INICIO` time NOT NULL,
  `HORA_FIM` time NOT NULL,
  `ATA` varchar(1000) NOT NULL,
  `FINALIZACAO` tinyint(1) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `ID_REUNIAO_FK` (`ID_REUNIAO_FK`)
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_detalhe_reuniao`
--

INSERT INTO `tb_detalhe_reuniao` (`ID`, `ID_REUNIAO_FK`, `HORA_INICIO`, `HORA_FIM`, `ATA`, `FINALIZACAO`) VALUES
(1, 1, '00:00:00', '11:00:00', 'TEXTO DA ATA', 1),
(2, 2, '05:00:00', '19:50:00', 'tete ATA', 1),
(3, 79, '17:00:00', '21:00:00', 'TESTE ATA FINAL', 1),
(4, 78, '10:00:00', '11:00:00', 'tste', 1),
(5, 76, '11:11:00', '22:22:00', '', 1),
(6, 77, '11:11:00', '22:22:00', 'tsete ata', 1),
(7, 74, '11:11:00', '12:22:00', 'aaaa', 1),
(8, 82, '10:00:00', '22:22:00', 'AAAAABBBBBBBBB', 1),
(9, 3, '10:00:00', '22:22:00', 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', 1),
(10, 83, '11:11:00', '22:22:00', 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', 1),
(11, 84, '10:00:00', '11:00:00', '', 1),
(12, 86, '10:00:00', '21:00:00', 'aa', 1),
(13, 87, '11:11:00', '22:22:00', 'ata teste', 1),
(14, 88, '10:00:00', '22:22:00', 'tttt', 1),
(15, 85, '10:00:00', '22:22:00', 'aaaaaaaaaaaaaaaaaaaaaaaaateste', 1),
(16, 89, '10:00:00', '11:00:00', 'teste', 1),
(17, 90, '11:11:00', '22:22:00', 'teste ata', 1),
(18, 91, '10:00:00', '22:22:00', 'TTTT', 1),
(19, 92, '11:11:00', '22:22:00', 'ata', 1),
(20, 93, '22:22:00', '11:11:00', 'tata', 1),
(21, 94, '11:11:00', '33:33:00', 'aa', 1),
(22, 96, '10:00:00', '22:22:00', 'teste ata', 1),
(23, 98, '10:00:00', '12:00:00', 'TESTE ATA', 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_detalhe_reuniao_docente`
--

DROP TABLE IF EXISTS `tb_detalhe_reuniao_docente`;
CREATE TABLE IF NOT EXISTS `tb_detalhe_reuniao_docente` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_REUNIAO_FK` int(11) NOT NULL,
  `ID_DOCENTE_FK` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `ID_REUNIAO_FK` (`ID_REUNIAO_FK`),
  KEY `ID_DOCENTE_FK` (`ID_DOCENTE_FK`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_detalhe_reuniao_docente`
--

INSERT INTO `tb_detalhe_reuniao_docente` (`ID`, `ID_REUNIAO_FK`, `ID_DOCENTE_FK`) VALUES
(3, 92, 31),
(1, 1, 31),
(4, 92, 32),
(5, 93, 32),
...
INSERT INTO `tb_discente` (`ID`, `NOME`, `CURSO`, `LATTES`) VALUES
(48, 'Carlos', 'Carlos Curso', 'http://lattes.com/goku');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_docentes`
--
...
CREATE TABLE IF NOT EXISTS `tb_docentes` (
  ...
  `DESC_TITULACAO` varchar(60) DEFAULT NULL,
  `LINK_LATTES` varchar(100) DEFAULT NULL,
  `FOTO` varchar(100) DEFAULT NULL,
  `ID_TITULACAO_FK` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_TB_DOCENTES_TB_TITULACAO1_IDX` (`ID_TITULACAO_FK`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_docentes`
--

INSERT INTO `tb_docentes` (`ID`, `NOME`, `DESC_TITULACAO`, `LINK_LATTES`, `FOTO`, `ID_TITULACAO_FK`) VALUES
(31, 'Bulma', 'Ciêntista', 'HTTP://LATTES.COM/BULMA', 'f729944dc7322c282a6a0c82b6b34023.jpg', 1),
(32, 'Vegeta', 'Principe dos Sayajins', 'HTTP://LATTES.COM/VEGETA', '4d95c45a64dcc00f300c03951365704b.jpg', 3),
(33, 'teste', 'teste', 'HTTPS://WWW.LATTES.COM/', '627d5f6d00a5a27e620543cc47a1ede7.jpg', 2),
(34, 'ICHIGO', 'teste', 'HTTPS://WWW.LATTES.COM/', '78cf322256ede94e00b4d24b8b92d8bd.jpg', 2);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_docente_grupo`
--

DROP TABLE IF EXISTS `tb_docente_grupo`;
CREATE TABLE IF NOT EXISTS `tb_docente_grupo` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_DOCENTE_FK` int(11) NOT NULL,
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_TB_DOCENTE_GRUPO_TB_DOCENTES1_IDX` (`ID_DOCENTE_FK`),
  KEY `FK_TB_DOCENTE_GRUPO_TB_GRUPO_PESQUISA1_IDX` (`ID_GRUPO_FK`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_docente_grupo`
--

INSERT INTO `tb_docente_grupo` (`ID`, `ID_DOCENTE_FK`, `ID_GRUPO_FK`, `DATA_CADASTRO`, `DATA_INICIO`, `DATA_TERMINO`) VALUES
(35, 31, 8, '2018-11-11 14:27:25', '2018-11-11 00:00:00', NULL),
(36, 32, 8, '2018-11-11 14:28:28', '2018-11-01 00:00:00', NULL),
(37, 33, 8, '2018-11-26 01:10:52', '2018-11-26 00:00:00', NULL),
(38, 34, 2, '2018-11-27 01:44:47', '2018-11-27 00:00:00', NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_docente_linha`
--

DROP TABLE IF EXISTS `tb_docente_linha`;
CREATE TABLE IF NOT EXISTS `tb_docente_linha` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_DOCENTE_FK` int(11) NOT NULL,
  `ID_LINHA_PESQUISA_FK` varchar(15) NOT NULL,
  `DATA_CADASTRO` datetime DEFAULT NULL,
  `DATA_INICIO` datetime DEFAULT NULL,
  `DATA_TERMINO` datetime DEFAULT NULL,
  `ID_GRUPO_FK` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_TB_DOCENTES_LINHA_TB_DOCENTES1_IDX` (`ID_DOCENTE_FK`),
  KEY `FK_TB_DOCENTES_LINHA_TB_LINHA_PESQUISA1_IDX` (`ID_LINHA_PESQUISA_FK`),
  KEY `GRUPO` (`ID_GRUPO_FK`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_docente_linha`
--

INSERT INTO `tb_docente_linha` (`ID`, `ID_DOCENTE_FK`, `ID_LINHA_PESQUISA_FK`, `DATA_CADASTRO`, `DATA_INICIO`, `DATA_TERMINO`, `ID_GRUPO_FK`) VALUES
(11, 31, '50101013', '2018-11-11 14:27:25', '2018-11-11 00:00:00', NULL, 8),
(12, 32, '50101013', '2018-11-11 14:28:28', '2018-11-01 00:00:00', NULL, 8),
(13, 33, '50101013', '2018-11-26 01:10:52', '2018-11-26 00:00:00', NULL, 8),
(14, 34, '10202013', '2018-11-27 01:44:47', '2018-11-27 00:00:00', NULL, 2);
...
INSERT INTO `tb_equipamentos` (`ID`, `NOME`, `DESCRICAO`, `DATA_INICIO`, `DATA_TERMINO`, `ID_GRUPO_FK`) VALUES
(22, 'Video Game', 'Para jogos do grupo  ', '2018-11-17 00:00:00', NULL, 8),
(23, 'Telescópio', 'Para observação  de sayajins', '2018-11-01 00:00:00', NULL, 8),
(20, 'Mesa', 'Para testes dos equipamentos', '2018-11-11 00:00:00', NULL, 8),
(21, 'Caixa de som', 'Equipamento musical', '2018-11-11 00:00:00', NULL, 8);
...
--
-- Extraindo dados da tabela `tb_grupo_lider`
--

INSERT INTO `tb_grupo_lider` (`ID`, `ID_GRUPO_FK`, `ID_LIDER_FK`, `DATA_INICIO`, `DATA_FIM`) VALUES
(2, 2, 6, '2018-11-26 00:00:00', NULL),
(7, 8, 6, '2018-11-11 14:20:00', NULL);
...
--
-- Extraindo dados da tabela `tb_grupo_pesquisa`
--

INSERT INTO `tb_grupo_pesquisa` (`ID`, `SIGLA`, `NOME`, `LOGOTIPO`, `DESCRICAO`, `DATA_INICIO`, `EMAIL`, `LINK_DGP`, `SITUACAO`) VALUES
(2, 'BLT', 'BLEACH', 'abd94805a7532f2f43c9cacde9496a2c.jpg', '  ', '2018-11-14 00:00:00', '', 'https://www.lattes.com/', 1),
(8, 'DBZ', 'Dragon Ball Z', '7205c507e67311ed58d784951f288258.jpg', 'Grupo Relacionado a Assuntos de DBZ  ', '2018-11-11 00:00:00', 'deagonball@dbz.com.br', 'http://lattes.com/bulma', 1);
...
(6, 'lider', 'LIDER', 'lider@lider.com.br', '55de1e4b50da90d84249ab53f61a99a6959d4c6fd8a6c402670b4115c137beae', 'lsmne8', 0, '2018-11-11', 'http://lattes.com/goku', '3f7ac7377982fa1029c821977f14ac11.jpg');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_linha_grupo`
--

DROP TABLE IF EXISTS `tb_linha_grupo`;
CREATE TABLE IF NOT EXISTS `tb_linha_grupo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `DESCRICAO` varchar(300) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_TB_LINHA_GRUPO_TB_LINHA_PESQUISA1_IDX` (`ID_LINHA`),
  KEY `FK_TB_LINHA_GRUPO_TB_GRUPO_PESQUISA1_IDX` (`ID_GRUPO`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_linha_grupo`
--

INSERT INTO `tb_linha_grupo` (`id`, `ID_LINHA`, `ID_GRUPO`, `DATA_CADASTRO`, `DATA_INICIO`, `DATA_TERMINO`, `DESCRICAO`) VALUES
(15, '50101013', 8, '2018-11-11 14:21:23', '2018-11-11 00:00:00', NULL, 'Teste'),
(16, '40101010', 8, '2018-11-11 14:30:19', '2018-11-16 00:00:00', NULL, 'Teste'),
(17, '10202013', 2, '2018-11-27 01:44:04', '2018-11-02 00:00:00', NULL, 'TESTE');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_linha_pesquisa`
--

DROP TABLE IF EXISTS `tb_linha_pesquisa`;
CREATE TABLE IF NOT EXISTS `tb_linha_pesquisa` (
...
--
-- Extraindo dados da tabela `tb_linha_pesquisa`
--

INSERT INTO `tb_linha_pesquisa` (`ID`, `NOME`) VALUES
...
DROP TABLE IF EXISTS `tb_orientacao`;
CREATE TABLE IF NOT EXISTS `tb_orientacao` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `DATA_INICIO` datetime DEFAULT NULL,
  `DATA_TERMINO` datetime DEFAULT NULL,
  `ID_PROJETO_FK` int(11) NOT NULL,
  `ID_DISCENTE_FK` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_TB_ORIENTACAO_TB_PROJETO_PESQUISA1_idx` (`ID_PROJETO_FK`),
  KEY `fk_TB_ORIENTACAO_TB_DISCENTE1_idx` (`ID_DISCENTE_FK`)
) ENGINE=MyISAM AUTO_INCREMENT=34 DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_orientacao` (`ID`, `DATA_INICIO`, `DATA_TERMINO`, `ID_PROJETO_FK`, `ID_DISCENTE_FK`) VALUES
(33, '2018-11-10 00:00:00', NULL, 11, 48);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_pauta`
--
...
--
-- Extraindo dados da tabela `tb_pauta`
--

INSERT INTO `tb_pauta` (`ID`, `DESCRICAO`, `ID_REUNIAO_FK`) VALUES
(1, 'INFORMATICA', 1),
(2, 'MATEMATICA GENERICA', 1),
(3, 'INGLÊS', 1),
(4, 'SINCRONIA CYBERNÉTICA', 2),
(55, 'b4', 3),
(54, 'b3', 3),
(32, 'p1', 79),
(27, '        c1', 77),
...
--
-- Estrutura da tabela `tb_projeto_colaboracao`
--

DROP TABLE IF EXISTS `tb_projeto_colaboracao`;
CREATE TABLE IF NOT EXISTS `tb_projeto_colaboracao` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_DOCENTE_FK` int(11) NOT NULL,
  `ID_PROJETO_FK` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_TB_PROJETO_COLABORACAO_TB_DOCENTES1_idx` (`ID_DOCENTE_FK`),
  KEY `fk_TB_PROJETO_COLABORACAO_TB_PROJETO_PESQUISA1_idx` (`ID_PROJETO_FK`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_projeto_pesquisa`
--

DROP TABLE IF EXISTS `tb_projeto_pesquisa`;
CREATE TABLE IF NOT EXISTS `tb_projeto_pesquisa` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `TITULO` varchar(100) NOT NULL,
  ...
  `DATA_TERMINO` datetime DEFAULT NULL,
  `ID_DOCENTE_FK` int(11) NOT NULL,
  `ID_LINHA_FK` int(11) NOT NULL,
  `ID_GRUPO_FK` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_TB_PROJETO_PESQUISA_TB_DOCENTES1_idx` (`ID_DOCENTE_FK`),
  KEY `fk_TB_PROJETO_PESQUISA_TB_LINHA_PESQUISA1_idx` (`ID_LINHA_FK`),
  KEY `grupo` (`ID_GRUPO_FK`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_projeto_pesquisa`
--

INSERT INTO `tb_projeto_pesquisa` (`ID`, `TITULO`, `TIPO`, `DATA_INICIO`, `DATA_TERMINO`, `ID_DOCENTE_FK`, `ID_LINHA_FK`, `ID_GRUPO_FK`) VALUES
(7, 'Projeto X', 'PIBIFSP', '2018-11-11 00:00:00', '2018-11-14 00:00:00', 32, 50101013, 8),
(11, 'Projeto Z', 'PIBIFSP', '2018-11-06 00:00:00', '2018-11-13 00:00:00', 31, 50101013, 8);
...
CREATE TABLE IF NOT EXISTS `tb_publicacao` (
  ...
  `ID_PROJETO_FK` int(11) NOT NULL,
  `ID_DOCENTE_FK` int(11) NOT NULL,
  `ID_LINHA_FK` varchar(15) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_TB_PUBLICACAO_TB_PROJETO_PESQUISA1_idx` (`ID_PROJETO_FK`),
  KEY `fk_TB_PUBLICACAO_TB_DOCENTES1_idx` (`ID_DOCENTE_FK`),
  KEY `fk_TB_PUBLICACAO_TB_LINHA_PESQUISA1_idx` (`ID_LINHA_FK`)
...
INSERT INTO `tb_publicacao` (`ID_GRUPO_FK`, `ID`, `TITULO`, `TIPO`, `DATA_PUBLICACAO`, `REFERENCIAS`, `ID_PROJETO_FK`, `ID_DOCENTE_FK`, `ID_LINHA_FK`) VALUES
(8, 2, 'TESTE X', 'Livro', '2019-02-01 00:00:00', 'TESTE X', 7, 32, '50101013'),
(8, 3, 'TESTE X 2 ', 'Anais de Congresso', '2021-03-02 00:00:00', 'XXXXXXXXX', 0, 32, '50101013');
...
--
-- Estrutura da tabela `tb_reuniao`
--
...
--
-- Extraindo dados da tabela `tb_reuniao`
--

INSERT INTO `tb_reuniao` (`ID`, `DATA`, `ID_GRUPO_FK`) VALUES
(1, '2018-11-16 00:00:01', 8),
(2, '2018-11-16 07:00:00', 8),
(3, '2018-11-22 08:00:00', 8),
(89, '2018-11-09 00:00:00', 8),
(88, '2018-10-28 00:00:00', 8),
(87, '2018-11-08 00:00:00', 8),
(86, '2018-11-07 00:00:00', 8),
(85, '2018-11-14 00:00:00', 8),
(84, '2018-11-21 00:00:00', 8),
(83, '2018-11-15 00:00:00', 8),
(82, '2018-11-23 00:00:00', 8),
(79, '2018-11-17 17:00:00', 8),
(78, '2018-11-13 00:00:00', 8),
(77, '2018-11-13 10:00:00', 8),
(76, '2018-11-13 00:00:00', 8),
(75, '2018-11-13 13:00:00', 8),
(74, '2018-11-13 00:00:00', 8),
(90, '2018-11-06 00:00:00', 8),
(91, '2018-10-29 00:00:00', 8),
(92, '2018-10-30 00:00:00', 8),
(93, '2018-10-31 00:00:00', 8),
(94, '2018-11-01 00:00:00', 8),
(95, '2018-11-02 00:00:00', 8),
(96, '2018-11-03 00:00:00', 8),
(97, '2018-10-29 00:00:00', 2),
(98, '2018-10-30 00:00:00', 2);
...
CREATE TABLE IF NOT EXISTS `tb_tecnico` (
  ...
  `LINK_LATTES` varchar(100) DEFAULT NULL,
  `ATIVIDADE_REALIZADA` varchar(100) DEFAULT NULL,
  `DESCRICAO_FORMACAO` varchar(50) DEFAULT NULL,
  `DATA_CONCLUSAO` datetime DEFAULT NULL,
  `FOTO` varchar(100) DEFAULT NULL,
  `TITULACAO_FK` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_TB_TECNICO_TB_TITULACAO1_IDX` (`TITULACAO_FK`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_tecnico_grupo`
--

DROP TABLE IF EXISTS `tb_tecnico_grupo`;
CREATE TABLE IF NOT EXISTS `tb_tecnico_grupo` (
  `ID_TECNICO_FK` int(11) NOT NULL,
  `ID_GRUPO_FK` int(11) NOT NULL,
  `DATA_CADASTRO` datetime DEFAULT NULL,
  `DATA_INICIO` datetime DEFAULT NULL,
  `DATA_TERMINO` datetime DEFAULT NULL,
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  KEY `FK_TB_TECNICO_LINHA_TB_TECNICO1_IDX` (`ID_TECNICO_FK`),
  KEY `FK_TB_TECNICO_GRUPO_TB_GRUPO_PESQUISA1_IDX` (`ID_GRUPO_FK`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(4, 'CADASTRO DE LINHAS DE PESQUISA', 'CADASTROLINHAPESQUISAADM.PHP'),
...
(16, 'ADICIONAR ITENS DA PAGINA INICIAL', 'ITENSSOBREGRUPO.PHP'),
(17, 'GRUPOS DE PESQUISA', 'TELAMOSTRAGRUPOS.PHP'),
(18, 'MEUS GRUPOS DE PESQUISA', 'TELAMOSTRAGRUPOSLIDER.PHP');
...
DROP TABLE IF EXISTS `tb_titulacao`;
...
INSERT INTO `tb_titulacao` (`ID`, `NOME`) VALUES
...
--
-- Limitadores para a tabela `tb_docentes`
--
ALTER TABLE `tb_docentes`
  ADD CONSTRAINT `FK_TB_DOCENTES_TB_TITULACAO1` FOREIGN KEY (`ID_TITULACAO_FK`) REFERENCES `tb_titulacao` (`ID`);

--
-- Limitadores para a tabela `tb_docente_grupo`
--
ALTER TABLE `tb_docente_grupo`
  ADD CONSTRAINT `FK_TB_DOCENTE_GRUPO_TB_DOCENTES1` FOREIGN KEY (`ID_DOCENTE_FK`) REFERENCES `tb_docentes` (`ID`),
  ADD CONSTRAINT `FK_TB_DOCENTE_GRUPO_TB_GRUPO_PESQUISA1` FOREIGN KEY (`ID_GRUPO_FK`) REFERENCES `tb_grupo_pesquisa` (`ID`);

--
-- Limitadores para a tabela `tb_docente_linha`
--
ALTER TABLE `tb_docente_linha`
  ADD CONSTRAINT `FK_TB_DOCENTES_LINHA_TB_DOCENTES1` FOREIGN KEY (`ID_DOCENTE_FK`) REFERENCES `tb_docentes` (`ID`),
  ADD CONSTRAINT `FK_TB_DOCENTES_LINHA_TB_LINHA_PESQUISA1` FOREIGN KEY (`ID_LINHA_PESQUISA_FK`) REFERENCES `tb_linha_pesquisa` (`ID`),
  ADD CONSTRAINT `GRUPO` FOREIGN KEY (`ID_GRUPO_FK`) REFERENCES `tb_grupo_pesquisa` (`ID`);
...
--
-- Limitadores para a tabela `tb_linha_grupo`
--
ALTER TABLE `tb_linha_grupo`
  ADD CONSTRAINT `FK_TB_LINHA_GRUPO_TB_GRUPO_PESQUISA1` FOREIGN KEY (`ID_GRUPO`) REFERENCES `tb_grupo_pesquisa` (`ID`),
  ADD CONSTRAINT `FK_TB_LINHA_GRUPO_TB_LINHA_PESQUISA1` FOREIGN KEY (`ID_LINHA`) REFERENCES `tb_linha_pesquisa` (`ID`);
...
--
-- Limitadores para a tabela `tb_tecnico`
--
ALTER TABLE `tb_tecnico`
  ADD CONSTRAINT `FK_TB_TECNICO_TB_TITULACAO1` FOREIGN KEY (`TITULACAO_FK`) REFERENCES `tb_titulacao` (`ID`);

--
-- Limitadores para a tabela `tb_tecnico_grupo`
--
ALTER TABLE `tb_tecnico_grupo`
  ADD CONSTRAINT `FK_TB_TECNICO_GRUPO_TB_GRUPO_PESQUISA1` FOREIGN KEY (`ID_GRUPO_FK`) REFERENCES `tb_grupo_pesquisa` (`ID`),
  ADD CONSTRAINT `FK_TB_TECNICO_LINHA_TB_TECNICO1` FOREIGN KEY (`ID_TECNICO_FK`) REFERENCES `tb_tecnico` (`ID`);
COMMIT;
