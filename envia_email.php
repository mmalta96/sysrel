...
//pega prontuario 	
$sql = "SELECT PRONTUARIO FROM tb_lider_pesquisa WHERE ID = '$id'";
...
//pegasenha 	
$sql = "SELECT SENHA FROM tb_lider_pesquisa WHERE ID = '$id'";
 $result = $conexao->query($sql);
...
//pega email usuario
 $sql = "SELECT EMAIL FROM tb_lider_pesquisa WHERE ID = '$id'";
 $result = $conexao->query($sql);
