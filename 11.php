...
<body>
	...
	<div class="container">
		...
		<?php 
            ...
            $ano = $_GET["ano"];
		?>
		<h3>Relatório de Projetos Finalizados do Grupo no ano de <?php echo $ano; ?></h3>

        <table class="table table-striped">
            <thead>
                <tr>
                    <th><h3>Projetos</h3></th>
                </tr>
            </thead>
            	...
            	<?php 
                    ...
                    $sql = "SELECT PP.TITULO, PP.TIPO, D.NOME AS DOCENTE, LP.NOME AS LINHA FROM
                    tb_projeto_pesquisa PP
                    INNER JOIN tb_docentes D
                    on D.ID = PP.ID_DOCENTE_FK

                    INNER JOIN tb_linha_pesquisa LP
                    ON LP.ID = PP.ID_LINHA_FK

                    AND PP.DATA_TERMINO BETWEEN '".$ano."-01-01 00:00:00' AND '".$ano."-12-31 23:59:59'
