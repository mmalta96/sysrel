...
<body>
	...
	<div class="container">
		...
		<?php 
            ...
            $ano = $_GET["ano"];
		?>
		<h3>Relatório de Técnicos do Grupo no ano de <?php echo $ano; ?></h3>

        <table class="table table-striped">
            <thead>
                <tr>
                    <th><h3>Técnicos</h3></th>
                </tr>
            </thead>
            	...
            	<?php 
                    ...
                    $sql = "SELECT *
                    FROM tb_tecnico T 
                    INNER JOIN tb_tecnico_grupo G
                    on G.ID_TECNICO_FK = T.ID
                    AND G.DATA_INICIO BETWEEN '".$ano."-01-01 00:00:00' AND '".$ano."-12-31 23:59:59'
                    OR  G.DATA_TERMINO BETWEEN '".$ano."-01-01 00:00:00' AND '".$ano."-12-31 23:59:59'
                    AND G.ID_GRUPO_FK = ".$_SESSION["idGrupoAtual"];
            		...
            		while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<h5>Formação: ".$row["DESCRICAO_FORMACAO"]."</h5>";
                        echo "<h5>Atividades Realizadas: ".$row["ATIVIDADE_REALIZADA"]."</h5>";
                        echo "<h5>Concluído em: ".$row["DATA_CONCLUSAO"]."</h5>";
